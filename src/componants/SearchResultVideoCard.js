...
const SearchResultVideoCard = ({ video }) => {
  return (
    ...
    <div className='flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.7] rounded-xl md:p-4'>
      ...
      <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-auto'>
        ...
        <div className='hidden md:flex items-center'>
          <div className='flex items-start mr-3'>
            <div className='flex h-9 w-9 rounded-full overflow-hidden'>
              <img className='h-full w-full object-cover' src={video?.author?.avatar[0]?.url} alt="avatar image" />
            </div>
          </div>
